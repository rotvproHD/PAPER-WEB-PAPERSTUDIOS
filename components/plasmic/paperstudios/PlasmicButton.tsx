...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 7xNG3XR7jCb/css
      ...
      {(
        ...
        <div
          ...
          className={classNames(projectcss.all, sty.startIconContainer, {
            ...
            [sty.startIconContainershape_rounded]: hasVariant(
              variants,
              "shape",
              "rounded"
            ),
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__uvWJs)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__c2Gww)}
                role={"img"}
              />
            ),
